...
# --- adb mock --------------------------------------------------------------
# The fake device lives in tests/lib/mock_adb.sh, shared with the dialog-less
# suite. One copy, because two would drift and the stale one would be whichever
# suite nobody was looking at.
